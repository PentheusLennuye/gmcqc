...
In 2022, I completed my Master of Management of Artificial Intelligence from
the Smith School of Business at Queen’s University in Kingston, Ontario. The
degree enables one to lead AI project teams, although I am quite happy being a
senior dev who can take care of his team as a colleague. Previously, I obtained
a BA in Computer Science from York University in Toronto way back in 1998. As a
professional, of course, I'm constantly looking to update. Flexibility is key.

## Current Interests

### Professional

- Functional Programming in furtherance of automation, infra-as-code, and
  microservice programming
- Information management, technical writing
- Presentation and teaching technique
- Quick network deployment: keeping up with GNU tools and other Linux-based
  services.

### Personal

- Family!
- Woodworking (I built my own office furniture)
- Personal Knowledge Management, specifically _Zettelkasten_
- Stoic philosophy as applied to mental health and our acceptance of the
  21st-century western experience
- Natural languages such as French, German, Japanese (on pause).

### Tools

- Software: My primary tools are nvim, Visual Studio Code, Kubernetes, and
  Docker. My secondary tool is Obsidian.
- Equipment:
  - Employer daily driver: MacBook Pro, Apple Silicon
  - Personal daily driver: personally built PC built on a Fractal North
    chassis running CachyOS.
  - Personal laptop: Thinkbook 14s Yoga IRL, also running CachyOS
  - Kubernetes cluster: HP ProDesk minis running NixOS
...
- Languages:
  ...
  - DSL's such as Ansible's YAML, Puppet's Ruby
  - I've forgotten PHP, Perl, C, Macro/Assembly and Commodore Basic.
  - Currently studying Haskell and Rust.

## Other

- Trained concert pianist. It comes in handy, believe it or not.
- Kyokushin/Shinkyokushin karateka. Shodan from Nakama Dojo, Quebec. 1st kyu,
  Shinkyokushin. Retired from injuries honourably sustained.
